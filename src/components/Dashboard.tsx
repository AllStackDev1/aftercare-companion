...
import { myomectomyBrochure } from '@/data/brochureData';
...
export const Dashboard = () => {
  ...
  const totalCheckableItems = myomectomyBrochure.sections.reduce(
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-primary">Myomectomy Recovery Companion</h1>
